...
// The side to which padding can be applied 
public enum Side
{
...
{
    public static GameObject SetAnchors(this RectTransform self, System.ValueTuple<Vector2, Vector2> anchors)
    {
    ...
    public static GameObject Reset(this RectTransform self)
    {
