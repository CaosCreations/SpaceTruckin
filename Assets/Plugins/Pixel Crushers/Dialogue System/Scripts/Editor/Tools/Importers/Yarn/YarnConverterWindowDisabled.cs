...
namespace PixelCrushers.DialogueSystem.Yarn
{
    ...
    public class YarnConverterWindowDisabled
    {
        ...
        {
            if (EditorUtility.DisplayDialog("Enable Yarn 1 Support", "Yarn 1 import support isn't enabled yet. Would you like to enable it? After clicking Enable, re-open the Yarn import window.", "Enable", "Cancel"))
            {
