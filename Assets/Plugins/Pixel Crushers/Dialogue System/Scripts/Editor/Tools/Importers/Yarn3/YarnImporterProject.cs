...
namespace PixelCrushers.DialogueSystem.Yarn3
{
    ...
    public class GroupBlock : BlockStatement
    {
        public GroupBlock() : base(StatementType.Group) { }
    }
    ...
    {
        public string SmartExpression { get; set; } = string.Empty;
    ...
    public class YarnImporterProject
    {
        ...
        public void AddNode(ConversationNode node)
        {
            ...
            {
                Debug.LogWarning("YarnImporterProject::Node Name is null or empty.");
            }
            else
            {
