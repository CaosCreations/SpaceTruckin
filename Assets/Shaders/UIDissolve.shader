    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                float noise = valueNoise(i.texcoord * _NoiseScale);

                float threshold = _Dissolve;
                clip(threshold - noise);

                float edge = 1.0 - smoothstep(0.0, _EdgeWidth, threshold - noise);
